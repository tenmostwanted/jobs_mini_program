package top.vertical.service.impl;
...
import top.vertical.mapper.WxMapper;
import top.vertical.pojo.User;
import top.vertical.service.WxService;
...
public class WxServiceImpl implements WxService {
  ...
  public User getAuthCode2Session(User user) throws IOException {
    HttpGet get =
            new HttpGet(AUTH_URL + "appid=" + user.getAppid() +
                    "&secret=" + user.getSecret() +
                    "&js_code=" + user.getJs_code() +
                    "&grant_type=" + user.getGrant_type());
